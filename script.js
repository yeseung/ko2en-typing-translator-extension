...
document.addEventListener('DOMContentLoaded', () => {
    ...
    document.getElementById("txtSource").addEventListener("keyup", () => doConvert());
    document.getElementById("optEtoH").addEventListener("click", () => doConvert());
    document.getElementById("optHtoE").addEventListener("click", () => doConvert());
